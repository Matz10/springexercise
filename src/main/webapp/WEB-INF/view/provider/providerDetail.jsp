...
<title>Spring forms :: City Provider details</title>
<!-- Bootstrap -->
<link
...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<h1><s:message code="title.providerDetail"></s:message></h1>
			<p><s:message code="subtitle.providerDetail"></s:message></p>
		</div>
		<c:choose>
			...
			<c:otherwise>
				<div><s:message code="comment.providerDetail"></s:message></div>
			</c:otherwise>
		</c:choose>
