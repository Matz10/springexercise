...
<div class="container">
	...
	<div class="jumbotron">
	<h1 title="<s:message code="title.cityCreated"></s:message>"><s:message code="title.cityCreated"></s:message></h1>

	<div class="alert alert-success" role="alert" title="<s:message code="subtitle.cityCreated"></s:message>"><s:message code="subtitle.cityCreated"></s:message></div>
		</div>
	<table class="table">
		<thead>
			<tr>
